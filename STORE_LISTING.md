# day1tabs — Chrome Web Store Listing

## Short Description (132 chars max)

Start every day with a clean browser. Auto-reset tabs at midnight, track what you actually use, and stop hoarding.
...
- **RAM estimation** — Shows estimated memory usage based on your open tab count.
- **30-minute undo** — Changed your mind? Restore all closed tabs within 30 minutes of a reset.
- **Manual reset** — Don't want to wait? Trigger a fresh start anytime from the popup.
- **Tab archive** — Browse what was closed, see how tabs were classified, and reopen anything you need.
- **Badge counter** — Color-coded badge shows your open tab count at a glance (green → amber → orange → red).
...
- **tabs** — To read, track, and close tabs.
- **storage** — To save settings, archives, and tracking data locally.
- **alarms** — To schedule the daily reset.
